...
|---|---|---|
| English | [Download `trackers-and-widgets-en.zip`](https://github.com/tankisthuieglot-hue/trackers-and-widgets/releases/latest/download/trackers-and-widgets-en.zip) | RPG HUD, Dice, Achievement, Clock, Relationship, Critics, Encounter Dossier, shared service regexes |
| Russian | [Download `trackers-and-widgets-ru.zip`](https://github.com/tankisthuieglot-hue/trackers-and-widgets/releases/latest/download/trackers-and-widgets-ru.zip) | RPG HUD, Dice, Achievement, Clock, Relationship, Critics, Encounter Dossier, shared service regexes |
