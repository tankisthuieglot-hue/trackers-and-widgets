...
|---|---|---|
| English | [Download `vladislav-en.zip`](https://github.com/tankisthuieglot-hue/vladislav/releases/latest/download/vladislav-en.zip) | RPG HUD, Dice, Achievement, Clock, Relationship, shared service regexes |
| Russian | [Download `vladislav-ru.zip`](https://github.com/tankisthuieglot-hue/vladislav/releases/latest/download/vladislav-ru.zip) | RPG HUD, Dice, Achievement, Clock, Relationship, shared service regexes |
